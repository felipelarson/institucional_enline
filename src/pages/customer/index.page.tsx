  ...
  return (
    <ContainerMain bg={"#F1F6FF"}>
      <Banner
        ...
        description={
          "Explore how Enline`s technology delivers customized benefits to a wide range of industries and customer types,"
        }
        descriptionColor={
          "driving efficiency and sustainability across the energy sector."
        }
      />
      <CardCustomer />
    </ContainerMain>
